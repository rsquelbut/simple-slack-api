...
class SlackUserImpl extends SlackPersonaImpl implements SlackUser {
    ...
    SlackUserImpl(String id, String userName, String realName, String userMail,
            boolean deleted, boolean admin, boolean owner, boolean primaryOwner, boolean restricted, boolean ultraRestricted, boolean bot, String timeZone,
